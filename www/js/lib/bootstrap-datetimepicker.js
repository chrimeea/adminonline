        ...
        b = function(o, q) {
		    ...
		    markedDate: new Date(),
                ...
                n = function() {
                    ...
                    Y = a(l.options.markedDate).year(), Q = l.widget.find(".datepicker-months").find("th:eq(1)").text(ab).end().find("span").removeClass("active");
                    if (Y === ab) {
                        Q.eq(a(l.options.markedDate).month()).addClass("active")
                    }
		/*
                    if (Y - 1 < aa) {
